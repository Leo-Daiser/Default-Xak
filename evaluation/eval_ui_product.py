...
def main() -> int:
    ...
    checks = {
        ...
        "answer_graph_available": "build_answer_graph(payload)" in ui_text and "answer_graph_to_html(answer_graph)" in ui_text,
        ...
        "answer_graph_has_semantic_path": all(token in answer_graph_labels for token in ["ВТ6", "отжиг", "прочность", "862–1120 MPa"]),
        ...
        and all(token in comparison_labels for token in ["ВТ6", "7075-T6", "980–1120 MPa", "455–531 MPa", "сравнение ограничено"]),
        ...
        "answer_graph_hierarchical_renderer": all(
            ...
            for token in ["hierarchical", "physics", "enabled: false", "zoomView", "dragView", "dragNodes"]
        ),
