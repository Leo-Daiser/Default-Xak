...
class KnowledgeExpansionEngine:
    ...
    def build_report(self, *, document_id: str | None = None, active_only: bool = True) -> dict[str, Any]:
        ...
        fact_rows, data_gaps, rejected_count = self._extract_rows(chunks)
    ...
    def _extract_rows(self, chunks: list[Chunk]) -> tuple[list[dict[str, Any]], list[dict[str, Any]], int]:
        ...
        return fact_rows, gaps, rejected_count
