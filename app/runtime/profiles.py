...
Profiles intentionally provide defaults only.  Explicit environment variables
such as RETRIEVAL_MODE or ENABLE_LLM always remain stronger than profile
defaults through Settings/BaseSettings.
"""
